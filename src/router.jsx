...
import MdaPages from "./pages/mdaPages/mdaPages";
import PublishBucket from "./pages/publich-bucket/PublishBucket";
    ...
    <Routes>
      {role === "admin" ? (
        <Route path="/">
          ...
          <Route path="applications" element={<MdaPages />} />
          <Route path="published-pages" element={<PublishBucket />} />
        ...
        <Route path="/">
          ...
          <Route
            path="*"
            element={<div className="pageNotFound"> Page not found </div>}
          />
        </Route>
      )}
    </Routes>
