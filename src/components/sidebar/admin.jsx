...
import { AppNotification } from "iconoir-react/regular";
...
export default function Admin() {
  return (
    <div className="menu__links">
      ...
      <a href="/applications" className="link applications">
        <div className="icon">
          <Laptop />
        </div>
      ...
      <a href="/published-pages" className="link published-pages">
        <div className="icon">
          <AppNotification />
        </div>
        <div className="text">Published Pages</div>
      </a>
